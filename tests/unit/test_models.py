...
class TestMessageQueue:
    ...
    def test_minimal_message(self):
        ...
        # Default canal é Twilio (compat com mensagens pré-migração 006).
        assert msg.channel == MessagingChannel.TWILIO

    def test_message_channel_meta(self):
        """Mensagem pode ser criada com canal explícito (meta/uazapi)."""
        msg = MessageQueue(
            id=2,
            phone_number="+5511999999999",
            agent_id="rhawk_assistant",
        ...
        assert msg.channel == MessagingChannel.META

    def test_message_channel_from_string(self):
        """Pydantic aceita string que bate com o enum (path do claim_next)."""
        msg = MessageQueue(
            id=3,
            phone_number="+5511999999999",
            agent_id="rhawk_assistant",
        ...
        assert msg.channel == MessagingChannel.UAZAPI
